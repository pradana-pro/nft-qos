...
m = Map("nft-qos", translate("Pradana Limit Client"))

--
-- Taboptions
--
s = m:section(TypedSection, "default", translate("Settings"))
s.addremove = false
s.anonymous = true
...
if limit_enable == "1" and limit_type == "static" then
	...
	x = m:section(TypedSection, "download", translate("Limit Download Rate"))
	x.anonymous = true
	x.addremove = true
...
--
	y = m:section(TypedSection, "upload", translate("Limit Upload Rate"))
	y.anonymous = true
	y.addremove = true
